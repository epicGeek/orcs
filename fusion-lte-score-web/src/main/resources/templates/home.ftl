				...
				<div class="col-md-12">
					...
					<div class="block1">
						<div class="row">
							...
							<div class="col-md-2 col-sm-4  col-xs-4 text-center">
								<a href="bsMap" class="btn n-icon n-icon-color2" role="button">
									<span class="fa-stack fa-lg">
			  ...
			  <div class="col-md-12">
				 ...
				 <div class="block1">
					<div class="row">
						...
						<div class="col-md-2 col-sm-4  col-xs-4 text-center">
							<a href="bsCurrentScore" class="btn n-icon n-icon-color4" role="button">
								<span class="fa-stack fa-lg">
						...
						<div class="col-md-2 col-sm-4  col-xs-4 text-center">
							<a href="bsCurrentScore?&tjType=2" class="btn n-icon n-icon-color5" role="button">
								<span class="fa-stack fa-lg">
						...
						<div class="col-md-2 col-sm-4  col-xs-4 text-center">
							<a href="bsCurrentScore?&tjType=3" class="btn n-icon n-icon-color3" role="button">
								<span class="fa-stack fa-lg">

...
<html lang="en">
	...
	<body>
			...
			<div class="rightContent container-fluid">
				<div class="row ">
					<div class="col-sm-12 col-md-12">
						<div class="block">
							<div class="header"><strong>告警时长统计</strong>
							...
							<div class="content no-padding-top no-padding-bottom">
								<div class="form-horizontal">
									<div class="form-group form-group-sm form-inline">
										...
										<label class="control-label">告警时长</label>
										<input id='alarmDelay' style="width: 150px;" />
										
										<label class="control-label">告警号</label>
										<input id='alarmNo' style="width: 150px;" />
		...
		<script type="text/javascript" src="custom/app/statistic/alarmDelay.js"></script>
	</body>

...
<html lang="en">
	...
	<input id="menu" value="${menu}" type="hidden"/>
			...
			<div class="rightContent container-fluid">
				<div class="row ">
					<div class="col-sm-12 col-md-12">
						<div class="block">
							<div class="header"><strong>基站基础信息</strong></div>
							<div class="content no-padding-top no-padding-bottom">
								<div class="form-horizontal">
									<div class="form-group form-group-sm form-inline">
										...
										<button id="btn-search" class="btn btn-primary btn-sm btn-rad">
											<i class="fa fa-search"></i> 查询
										</button>
										<button id="btn-reset" class="btn btn-default btn-sm btn-rad">
							...
							<div class="content  text-center no-padding-top">
								<div id='cellList' class="table-noWrap"></div>
							</div> 
		...
		<script type="text/javascript" src="custom/app/scoreRules/informationCell.js"></script>
	</body>

...
<html lang="en">
	...
	<input id="menu" value="${menu}" type="hidden"/>
			...
			<div class="rightContent container-fluid">
				<div class="row ">
					<div class="col-sm-12 col-md-12">
						<div class="block">
							<div class="header"><strong>健康度指标明细</strong>
							...
							<div class="content no-padding-bottom">
								<div class="form-horizontal">
									<div class="form-group form-group-sm form-inline">
										...
										<input type="text" id="btnTimeStart"> -
										<input type="text" id="btnTimeEnd">
							...
							<div class="content  text-center no-padding-top">
								<div id='kpiScoreList' class="table-noWrap"></div>
		...
		<script type="text/javascript" src="custom/app/score/indicatorCurrentScore.js"></script>
	</body>

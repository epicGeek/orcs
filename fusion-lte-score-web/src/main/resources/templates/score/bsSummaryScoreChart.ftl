...
<html lang="en">
	...
	<body>
		...
		<input type="hidden" id="neName" value="${neName}">
					...
					<div class="col-sm-12 col-md-12">
						<div class="block">
							<div class="header clearfix">
								<div class="pull-left"><strong>基站明细</strong></div>
							...
							<div class="content no-padding-bottom">
								<div class="form-horizontal">
									<div class="form-group form-group-sm form-inline">
										...
										<input type="text" id="sumStartDate"> -
										<input type="text" id="sumEndDate">
		...
		<script type="text/javascript" src="custom/app/score/bsSummaryScoreChart.js"></script>
	</body>

...
<!-- 雷达图 -->
	...
	<input id="menu" value="${menu}" type="hidden"/>
						  ...
						  <!--  <input id="type" value="" type="hidden"/> -->
							...
							<div class="header no-border"><strong id='name'></strong>
							    <div class="pull-right">
								    <button  class="btn btn-default btn-rad" onClick="javascript:history.back(-1);"><i class="fa fa-fast-backward"></i>返回 </button>
							    </div>
							</div>
							<div class="content">
									<div class='form-inline'>
										...
										<div class='form-group'>
											<button  type='button' id="searchBtn" class="btn btn-primary btn-sm btn-rad">
		...
		<script type="text/javascript" src="custom/app/score/bts_radarChart.js"></script>
	</body>

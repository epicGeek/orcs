...
<html lang="en">
	...
	<body>
			...
			<div class="rightContent container-fluid">
				<div class="row ">
					<div class="col-sm-12 col-md-12">
						<div class="block">
							<div class="header"><strong>角色管理</strong></div>
							<div class="content no-padding-top no-padding-bottom">
								<div class="form-horizontal">
									<div class="form-group form-group-sm form-inline">
										...
										<input class="form-control" id="inputKeyWord" placeholder="角色名称过滤..." maxlength="20"/>
					...
					<div class="modal-body">
						<div class="form-horizontal text-center">
							<div class="form-group-sm form-inline">
								...
								<input id='roleName' type="text" class="form-control" value="" maxlength="20"/>
							</div>

							<div class="form-group-sm form-inline">
								<label class="control-label">权限等级</label>
								<select id='authority' class="form-control" value=""> </select>
							</div>
							<div class="form-group-sm form-inline">
								<label class="control-label">角色描述</label>
								<input id='roleDesc' type="text" class="form-control" value="" maxlength="50"/>
							</div>
						</div>
					</div>
		...
		<div id='bindCheckItemsWindow' style="display: none;">
		<div class="container-fluid" >
			<div id="bindCheckItemsWindowtree">
				<div id='checkItemsTree' style="height: 350px;"></div>
			</div>
			<div class="k-edit-buttons k-state-default text-right windowFooter">
				<a id='saveMenu'  class="k-button k-button-icontext k-primary k-grid-update">
					<span class="k-icon k-update"></span>保存
				</a>
				<a id='cancelMenu'  class="k-button k-button-icontext k-grid-cancel">
       ...
       <!-- 用户成员弹窗-->
		<div id='usersWindow' style="display: none;">
			<div class="container-fluid">
				...
				<div class="form-inline">
					...
					<button id="userBtn" type="submit" class="btn btn-primary btn-sm"><i class="fa fa-search" ></i> 查询</button>
					<button id="userClear" type="submit" class="btn btn-default btn-sm"><i class="fa fa-repeat"></i> 重置</button>
				</div>
		...
		<div id='areaWindow' style="display: none;">
			<div class="container-fluid">
				<div class="form-group">
					<div class="col-md-5">
						<input id="area-href" class="form-control input-sm" type="hidden" />
					</div>
				</div>
				<div class="form-inline">
					<div class="form-group form-group-sm ">
						<label>筛选</label>
						<input id="areaSearchName" type='text' class="form-control" placeholder="地区编码、地区名称" style="width: 300px;" />
					</div>
					<button id="areaBtn" type="submit" class="btn btn-primary btn-sm"><i class="fa fa-search" ></i> 查询</button>
					<button id="areaClear" type="submit" class="btn btn-default btn-sm"><i class="fa fa-repeat"></i> 重置</button>
				</div>
				<div id='areaGrid'></div>
			</div>
		</div>

...
<html lang="en">
	...
	<body>
			...
			<div class="rightContent container-fluid">
				<div class="row ">
					<div class="col-sm-12 col-md-12">
						<div class="block">
							<div class="header"><strong>告警查询</strong>
								...
								<div class="blockquote text-left">
									<div class="btn-group" data-toggle='buttons'>
										<label class="btn btn-info">
											<input type="radio" name="options" autocomplete="off" value="ices_alarm_monitor_delay"/> 时    长
										</label>
										<label class="btn btn-info">
											<input type="radio" name="options" autocomplete="off" value="ices_alarm_monitor_frequency" /> 频    次
										</label>
									</div>
								</div>
								<div id='alarmQueryList' class="table-noWrap"></div>
		...
		<script type="text/javascript" src="custom/app/dataQuery/currentAlarm.js"></script>
	</body>

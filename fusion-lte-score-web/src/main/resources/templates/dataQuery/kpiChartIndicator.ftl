...
<html lang="en">
	...
	<body>
		...
		<input type="hidden" id="h_areaCode" value="">
	    <input type="hidden" id="h_cityCode" value="">
			...
			<div class="rightContent container-fluid">
				<div class="row ">
					<div class="col-sm-12 col-md-12">
						<div class="block">
							<div class="header"><strong>KPI图形指标</strong></div>
		...
		<script type="text/javascript" src="custom/app/dataQuery/kpiChartIndicator.js"></script>
	</body>

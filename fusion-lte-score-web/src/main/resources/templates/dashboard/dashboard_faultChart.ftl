...
<html lang="en">
	...
	<input id="menu" value="${menu}" type="hidden"/>
			...
			<div class="rightContent container-fluid">
				<div class="row ">
					<div class="col-sm-12 col-md-12">
						<div class="block">
								<div class="header no-border"><strong id="sumTxt"></strong>
									    <div class="pull-right">
								    		<button  class="btn btn-default btn-rad" onClick="javascript:history.back(-1);">
								    			<i class="fa fa-fast-backward"></i>返回 
								    		</button>
							    		</div>
								</div>
								<div class="content">
									<div id='faultChart' style="height: 350px;"></div>
									<span class="tipText">
										提示：点击图中柱子跳转到故障原因统计
									</span>
								</div>
		...
		<script type="text/javascript" src="custom/app/dashboard/dashboard_faultChart.js"></script>
	</body>

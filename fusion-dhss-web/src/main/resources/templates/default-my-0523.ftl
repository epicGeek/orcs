	...
	<body class="bodyBg">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-3">
                        <div class="home-nav-item">
                            ...
                            <ul>
                                ...
                                <!--<li><a href="securityState"><i class="glyphicon glyphicon-search"></i> <span class="title">应急保障状态查询</span></a></li>-->
                        ...
                        <div class="home-nav-item">
                            ...
                            <ul>
                                ...
                                <li><a href="userDataQuery_advanced"><i class="glyphicon glyphicon-user"></i> <span class="title">高级用户数据查询</span></a></li>
                                <li><a href="userQueryMulti"><i class="glyphicon glyphicon-upload"></i> <span class="title">批量用户数据查询</span></a></li>
                                <li><a href="businessSearch"><i class="glyphicon glyphicon-search"></i> <span class="title">用户BOSS业务查询</span></a></li>
                                <li><a href="userDataManage"><i class="glyphicon glyphicon-baby-formula"></i> <span class="title">用户数据管理</span></a></li>
                                <li><a href="businessMonitor"><i class="glyphicon glyphicon-eye-open"></i> <span class="title">BOSS业务实时监控</span></a></li>
                            	<!--<li><a href="networkElementOperationLog"><i class="glyphicon glyphicon-retweet"></i> <span class="title">网元操作日志</span></a></li>
                            	<!--<li><a href="businessSearch"><i class="glyphicon glyphicon-retweet"></i> <span class="title">BOSS业务历史回溯</span></a></li>-->
                            	<li><a href="boss-rev-query"><i class="glyphicon glyphicon-stats"></i> <span class="title">BOSS业务数据查询</span></a></li>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                        <div class="home-nav-item">
                            ...
                            <ul>
                            	<!-- <li><a href="maintain-security"><i class="glyphicon glyphicon-stats"></i> <span class="title">安全管理</span></a></li> -->
                                ...
                                <!-- <li><a href="intelligentOperation/overallIndicator.html"><i class="glyphicon glyphicon-stats"></i> <span class="title">总体指标</span></a></li>-->
                                <!--<li><a href="DailyOperation/safetyManagement.html"><i class="glyphicon glyphicon-equalizer"></i> <span class="title">日常运维</span></a></li>-->
                                <!--<li><a href="intelligentOperation/oneKeyBackup.html"><i class="glyphicon glyphicon-level-up"></i> <span class="title">一键备份</span></a></li>-->
                                <!--<li><a href="intelligentOperation/alarmMonitor.html"><i class="glyphicon glyphicon-alert"></i> <span class="title">告警管理</span></a></li>-->
                                <!--<li><a href="intelligentOperation/intelligentInspection.html"><i class="glyphicon glyphicon-retweet"></i> <span class="title">智能巡检</span></a></li>-->
                                <!--<li><a href="intelligentOperation/nodeSwitching.html"><i class="glyphicon glyphicon-resize-small"></i> <span class="title">板卡倒换</span></a></li>-->
                            	<li><a href="monitor"><i class="glyphicon glyphicon-resize-small"></i> <span class="title">智能报表</span></a></li>
                            	<!--<li><a href="alarmManage"><i class="glyphicon glyphicon-alert"></i> <span class="title">告警管理</span></a></li>-->
                            	
                            </ul>
                        </div>
                        <div class="home-nav-item">
                            <!--<h4 class="home-nav-item-title">场景保障</h4>-->
                            <ul>
                                <!--<li><a href="nodeIsolation"><i class="glyphicon glyphicon-file"></i> <span class="title">单元隔离</span></a></li>
                                <li><a href="nodeRecoveryList"><i class="glyphicon glyphicon-file"></i> <span class="title">单元恢复</span></a></li>-->
                                <!-- <li><a href="businessSearch"><i class="glyphicon glyphicon-retweet"></i> <span class="title">BOSS业务历史回溯</span></a></li> 
                                <li><a href="#" class="disable"><i class="glyphicon glyphicon-floppy-open"></i> <span class="title">网元故障应急</span></a></li>
                                <li><a href="#" class="disable"><i class="glyphicon glyphicon-save-file"></i> <span class="title">链通故障应急</span></a></li>-->
                            </ul>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-3">
                        <div class="home-nav-item">
                            ...
                            <ul>
                                ...
                                <li><a href="oneKeyBackup" hrefa="external:oneKeyBackup"><i class="glyphicon glyphicon-retweet"></i> <span class="title">一键备份</span></a></li>
                                ...
                                <!-- <li><a href="smartCheckJobResult" ><i class="glyphicon glyphicon-save-file"></i> <span class="title">智能巡检</span></a></li> -->
                                <li><a href="smart" ><i class="glyphicon glyphicon-save-file"></i> <span class="title">智能巡检</span></a></li>
                            	<!--<li><a href="nodeSwitching"><i class="glyphicon glyphicon-file"></i> <span class="title">单元倒换</span></a></li>-->
                            	<!--<li><a href="neSwitching"><i class="glyphicon glyphicon-file"></i> <span class="title">网元倒换</span></a></li>-->
                            	<li><a href="ems-home"><i class="glyphicon glyphicon-folder-close"></i> <span class="title">设备监控系统</span></a></li>
                            	<!--<li><a href="kpi-threshold" ><i class="glyphicon glyphicon-save-file"></i> <span class="title">KPI门限管理</span></a></li>-->
                            	<li><a href="volte-home"><i class="glyphicon glyphicon glyphicon-transfer"></i> <span class="title">VOLTE自动开通</span></a></li>
                            	<!-- <li><a href="volte-list"><i class="glyphicon glyphicon glyphicon-transfer"></i> <span class="title">VOLTE自动开通记录</span></a></li>
                            	<li><a href="volte-counter"><i class="glyphicon glyphicon-folder-close"></i> <span class="title">VOLTE自动开通统计</span></a></li>
                            	<li><a href="volte-alarm"><i class="glyphicon glyphicon-folder-close"></i> <span class="title">VOLTE自动告警</span></a></li>-->
                            </ul>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                        <div class="home-nav-item">
                            ...
                            <ul>
                                <!--<li><a href="#" class="disable"><i class="glyphicon glyphicon-user"></i> <span class="title">账号管理</span></a></li>-->
                                <!--<li><a href="#" class="disable"><i class="glyphicon glyphicon-console"></i> <span class="title">系统日志查询</span></a></li>-->
                                <!--<li><a href="AdvancedFunction/logs.html"><i class="glyphicon glyphicon-modal-window"></i> <span class="title">网元操作日志</span></a></li>-->
                                <!--<li><a href="#" class="disable"><i class="glyphicon glyphicon-cog"></i> <span class="title">权限分配管理</span></a></li>-->

                                <li><a href="system-home"><i class="glyphicon glyphicon-object-align-vertical"></i> <span class="title">权域分配管理</span></a></li>
                                <!--<li><a href="system-area"><i class="glyphicon glyphicon-map-marker"></i> <span class="title">地区管理</span></a></li>
                                <li><a href="equipment-ne"><i class="glyphicon glyphicon-calendar"></i> <span class="title">网元管理</span></a></li>
                                <li><a href="equipment-unit"><i class="glyphicon glyphicon-sound-dolby"></i> <span class="title">单元管理</span></a></li>
                                <li><a href="system-user"><i class="glyphicon glyphicon-user"></i> <span class="title">用户管理</span></a></li>
                                <li><a href="system-role"><i class="glyphicon glyphicon-cog"></i> <span class="title">角色管理</span></a></li>
                                <li><a href="system-resource"><i class="glyphicon glyphicon-cog"></i> <span class="title">菜单管理</span></a></li>
                                <li><a href="check-item"><i class="glyphicon glyphicon-bookmark"></i> <span class="title">指令管理</span></a></li>
                                <li><a href="command-group"><i class="glyphicon glyphicon-oil"></i> <span class="title">指令组管理</span></a></li>
                                <li><a href="smartCheckManage"><i class="glyphicon glyphicon-oil"></i> <span class="title">巡检方案配置</span></a></li> -->
                                <li><a href="operation-log" ><i class="glyphicon glyphicon-save-file"></i> <span class="title">操作日志</span></a></li>
                                <li><a href="kpi-threshold" ><i class="glyphicon glyphicon-save-file"></i> <span class="title">KPI门限管理</span></a></li>
                                <!-- <li><a href="smartCheckManage"><i class="glyphicon glyphicon-object-align-vertical"></i> <span class="title">巡检方案配置</span></a></li>-->
                            </ul>
                        </div>
                    </div>
                </div>
		...
		<script>
			<#list menus as menu>
				...
				$(".home-nav-item ul li  a[hrefa='${menu.menuCode}']").show();
			</#list>

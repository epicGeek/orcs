...
<body class="page-product">
	 ...
	 <input type="hidden"  id="case" value="${caseid}" class="form-control"/>
	 <input type="hidden"  id="action" value="${action}" class="form-control"/>
	 <input type="hidden"  id="ne" value="${ne}" class="form-control"/>
	 <input type="hidden"  id="caseName" value="${caseName}" class="form-control"/>
	 <div class="container-fluid">
			<div class="row noMarginBottom">
				<div class="col-sm-5 marginTop10">
					<div class="panel panel-default panelLighter">
						<div class="panel-heading">网元倒换</div>
						<div class="panel-body ">
							<div class="row noMarginTop">
								<div class="form-inline noPadding">
									...
									<div class="form-group form-group-xs">
										<label>场景</label>
										<input type="text" name="" id="cjInput" value="" class="form-control"/>
									</div>
									<div class="form-group form-group-xs">
										<label>操作</label>
...
<!--//板卡倒换 弹出信息-->
		...
		<script src="custom/app/node/neSwitching.js"></script>
</body>
</html>
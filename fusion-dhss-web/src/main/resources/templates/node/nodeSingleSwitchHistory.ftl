				...
				<div class="col-xs-12 content-right">
					<div class="col-md-12 right-content">
						...
						<div class="console-title clearfix">
							<div class="pull-left">
								<h4>
									板卡倒换历史查询<span class="fa fa-question-circle" popover=""
							...
							<div class="pull-right">
								<a class="btn btn-xs btn-primary" href="javascript:void(0)"
									...
									class="glyphicon glyphicon-level-up"></i> 板卡倒换</a>
							</div>
						</div>
						<div class="console-body">
							...
							<div class="search-item">
								...
								<button class="btn btn-info" onclick="doSearchSingleHistory()">查询</button>
							</div>
						</div>
						<div id="gridSingleHistory"></div>
					</div>
				</div>
			</div>
		</div>
	</div>
	<form id="downloadSingleNodeSwitchFile" action="nodeSwitch/downloadSingleNodeSwitchFile">
       ...
       <input id="rowUnitName" name="rowUnitName" type="hidden"/>
   </form>
	<!--弹出信息-->
	<div id="showSingleLogWindows" style="display: none">
...
<script src="../assets/js/node/nodeSingleSwitchHistory.js"></script>
</body>
</html>

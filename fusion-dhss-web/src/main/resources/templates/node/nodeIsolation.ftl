                    ...
                    <div class="row">
                        <div class="col-sm-8 console-body">
                            <div class="search-item text-center">
                                <span>网元类型：</span>
                                <input id="inputSite" placeholder="请选择..." />
                                <span>网元：</span>
                                <input id="inputType" placeholder="请选择..." />
                                <span>节点：</span>
                                <input id="inputNode" placeholder="请选择..." />
                            </div>
                            ...
                            <div class="search-item clearfix">
                                <p>隔离<mark id="site"></mark> - <mark id="neType"></mark> - <mark id="unit"></mark>节点</p>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">节点隔离</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="doIsolation()">开始隔离</button>
            </div>
        </div>
    </div>
</div>
<!--//弹出信息-->
		...
		<!--//底部-->
		<@script></@script>
<script src="custom/app/node/nodeIsolation.js"></script>
</body>
</html>

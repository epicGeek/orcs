...
<html>
	...
	<body class="bodyBg">
        ...
        <div class="n-main-home">
            <div class="container">
                <div class="row">
                    <a href="alarm-new"><div class="col-xs-6 col-sm-6 col-md-3" >
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-3">
                        <div class="mainbox  n-icon-color3">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                    	<div>今日CPU巡检异常单元</div>
                                        <div id="smartCheckResult">正在获取... </div>
                                    </div>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3">
                        ...
                        <div class="home-nav-item">
                            ...
                            <ul>
                                ...
                                <li><a href="boss-rev-query"><i class="glyphicon glyphicon-search"></i> <span class="title">BOSS业务数据查询</span></a></li>
                                <li><a href="boss-rev-kpi"><i class="glyphicon glyphicon-eye-open"></i> <span class="title">BOSS数据统计</span></a></li>
		...
		<script>
			$(".home-nav-item ul li  a").addClass("disable");
		</script>
		...
		<script>
			...
			<#list menus as menu>
				$(".home-nav-item ul li  a[href='${menu.menuCode}']").attr("class","");
			</#list>
		</script>
	</body>

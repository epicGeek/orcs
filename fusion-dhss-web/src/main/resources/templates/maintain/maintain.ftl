...
<html>
	...
	<body>
			...
			<div class="row noMarginBottom">
				...
				<div class="col-sm-5 marginTop10">
					<div class="panel panel-default panelLighter">				   
						<div class="panel-heading"><span class="badge">1</span>&nbsp;选择单元&nbsp;---&nbsp;<a href="${category_url}?filterType=1">按指令过滤</a></div>
				...
				<div class="col-sm-3 marginTop10 noPadding ">
					<div class="panel panel-default panelLighter">
						<div class="panel-heading"><span class="badge">2</span> 选择指令</div>
				...
				<div class="col-sm-4 marginTop10">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<input type="text" name="" id="checkSelect" value="" class="form-control" placeholder="任务名称"/>
       ...
       <div id='paramsWindow' style="display: none;">
		...
		<!-- echarts -->
		<@script></@script>
		<script type="text/javascript" src="custom/app/maintain/maintain-new.js" ></script>

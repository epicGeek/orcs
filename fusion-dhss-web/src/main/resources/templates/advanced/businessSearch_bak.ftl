				...
				<div class="col-sm-12" style="width:auto">
                    <div class="form-inline">
                        ...
                        <div class="form-group form-group-sm">
							...
							<input type="text" style="height:30px;width:120px;padding-bottom:5px; border-radius: 4px;border: 1px solid #cccccc;" placeholder="输入错误编码..." id="inputError" >
						</div>
					</div>
                    <div class="form-inline">
						<div class="form-group form-group-sm">
						...
						<div class="form-group form-group-sm">
							...
							<input type="text" style="height:34px;width:373px; border-radius: 4px;border: 1px solid #cccccc;" placeholder="输入imsi或msisdn,多个号码使用“,”分隔开" id="inputValue" >
						</div>
						 <div class="form-group form-group-sm">

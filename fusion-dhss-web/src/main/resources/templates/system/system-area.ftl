...
<html>
	...
	<body>
		...
		<div class="container-fluid" >
			<div class="row">
				...
				<div class="col-sm-4  col-xs-12">
					<input id="inputKeyWord" value="" type="text" class="form-control input-sm" placeholder="筛选地区名称" style="width: 100%;" title="对MSISDN号段、IMSI号段进行模糊查询" />
				</div>
		...
		<@script></@script>
		<script src="custom/app/system/system-area.js"></script>
	</body>
</html>
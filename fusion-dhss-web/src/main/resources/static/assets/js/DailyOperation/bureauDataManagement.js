$(function() {
	...
	$("#topNavList .navListWrap:eq(1) ul li:eq(2)").addClass("active");
	
	//选择指令
	$("#instructionWrap").height($(window).height() - $("#instructionWrap").offset().top - 120);
	...
	$("#queryGrid").kendoGrid({
		...
		height:$(window).height() - $("#queryGrid").offset().top - 65,

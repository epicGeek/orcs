...
public class ZipCompressUtil {
	public static String compress(String[] srcPath, String destPath, String zipFileName) {
		...
		for (String s : srcPath) {
			...
			System.out.println(">>>>>>压缩文件【" + s + "】到【" + destPath + " 】目录下<<<<<<");
	...
	public static String compress(List<String> srcPath, String destPath, String zipFileName) {
		File zipFile = new File(destPath, zipFileName);
		Project prj = new Project();
		Zip zip = new Zip();
		zip.setProject(prj);
